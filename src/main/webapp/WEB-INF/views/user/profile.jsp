		...
		<div class="profile-left">
			<div class="profile-img-wrap story-border"
				...
				<img class="profile-image" src="/upload/${dto.user.profileImageUrl}"
					onerror="this.src='/images/3135789.png'" id="userProfileImage" />
			</div>
		</div>
		<!--유저이미지end-->
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<c:forEach var="image" items="${dto.user.images}"> <!-- el표현식에서 변수명을 적으면 get함수가 자동호출 됨 -->
				<div class="img-box">
...
<div class="modal-info" onclick="modalInfo()">
	<div class="modal">
		<button onclick="location.href='/user/${principal.id}/update'">회원정보 변경</button>
...
<div class="modal-image" onclick="modalImage()">
	<div class="modal">
		<p>프로필 사진 바꾸기</p>
		<button onclick="profileImageUpload(${dto.pageOwnerState},${principal.id})">사진 업로드</button>
